...
func main() {
	cli := cmdline.New()
	cli.AddOption("t", "token", "token", "circleci token")
	cli.AddOption("v", "vcs-type", "github", "the vcs type of the project")
	cli.AddOption("u", "username", "username", "the username who host the project")
	cli.AddOption("p", "project", "project-name", "the circleci project name")
